...
public class ListSorterTest {
    ...
    public void sort() {
        ...
        List<Integer> list = initializeList(MODE_SEQUENTIAL, 3, 2, 6, 1, 4, 5, 7);

        List<Integer> expected = initializeList(MODE_SEQUENTIAL, 1, 2, 3, 4, 5, 6, 7);
        ...
        expected = initializeList(MODE_SEQUENTIAL, 1, 2, 2, 4);
