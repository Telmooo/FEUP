...
class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        // global light
        this.gui.add(this.scene, 'globalLight', 0.01, 1.0).name("Global Light");
        ...
        this.gui.add(this.scene, 'tangramCustom').name('Tangram Custom').onChange(this.scene.updateTangramCustom.bind(this.scene));
